# Prattle - Contributing

Prattle `github.com/gojekfarm/prattle` is an open-source project.
...
1.  [File an issue][2] 
    ...
    <foss+prattle@go-jek.com> about future work.
...
[2]: https://github.com/gojekfarm/prattle/issues
